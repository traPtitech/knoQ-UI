...
import {
    ResponseEventDetailAttendees,
    ResponseEventDetailAttendeesFromJSON,
    ResponseEventDetailAttendeesFromJSONTyped,
    ResponseEventDetailAttendeesToJSON,
    ResponseEventTags,
...
export interface ResponseEventDetail {
    ...
    /**
     * 
     * @type {Array<ResponseEventDetailAttendees>}
     * @memberof ResponseEventDetail
     */
    attendees: Array<ResponseEventDetailAttendees>;
    /**
     * 
     * @type {string}
     * @memberof ResponseEventDetail
...
export function ResponseEventDetailFromJSONTyped(json: any, ignoreDiscriminator: boolean): ResponseEventDetail {
    ...
    return {
        ...
        'attendees': ((json['attendees'] as Array<any>).map(ResponseEventDetailAttendeesFromJSON)),
...
export function ResponseEventDetailToJSON(value?: ResponseEventDetail | null): any {
    ...
    return {
        ...
        'attendees': ((value.attendees as Array<any>).map(ResponseEventDetailAttendeesToJSON)),
